...
Per-client guides: [`docs/mcp/`](https://github.com/garrytan/gbrain/blob/master/docs/mcp/DEPLOY.md). Hardening defaults, env vars, and threat model: [SECURITY.md](https://github.com/garrytan/gbrain/blob/master/SECURITY.md).
